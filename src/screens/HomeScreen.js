        ...
        <View style={styles.container}>
            ...
            <ScrollView bounces={false}>
                <View style={styles.home}>
                    <Text style={styles.text1} >Health Emergency?</Text>
                    <Text style={styles.text1a} > Need commute to Hospital?</Text>
            ...
            <StatusBar style='light' backgroundColor={colors.red} translucent={true} />
        </View>
    )
}
